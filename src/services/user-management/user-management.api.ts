...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  auth = {
     ...
     */
    signupUser: (data: AuthSignupInput, params: RequestParams = {}) =>
     ...
     */
    signupConfirmation: (data: AuthConfirmationInput, params: RequestParams = {}) =>
     ...
     * @request POST:/auth/login/confirm
     */
    loginConfirmation: (data: AuthConfirmationInput, params: RequestParams = {}) =>
      this.request<void, any>({
