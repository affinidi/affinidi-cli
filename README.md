...
The [Ticketing reference app](https://github.com/affinidi/reference-app-ticketing) provides a simple web interface for issuing, claiming and verifying VCs. It can be quickly generated by typing:
