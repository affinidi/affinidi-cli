...
The [Certification and Verification App](https://github.com/affinidi/elements-reference-app-frontend) provides a simple web interface for issuing, claiming and verifying VCs. It can be quickly generated by typing:

```
$ affinidi generate-application --use-case=u certification-and-verification
```

You can also specify a name with:

```
$ affinidi generate-application --name=<value> --use-case=certification-and-verification
```
...
$ affinidi generate-application -n ExampleApp -u certification-and-verification
